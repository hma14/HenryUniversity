...
universityapp.factory('Course', ['$resource', function ($resource) {
...
universityapp.factory('Student', ['$resource', function ($resource) {
...
universityapp.service('popupService', function ($window) {
